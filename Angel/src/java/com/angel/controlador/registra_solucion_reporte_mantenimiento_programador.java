 ...
 * @author devil
 */
@WebServlet(name = "registra_solucion_reporte_mantenimiento_programador", urlPatterns = {"/registra_solucion_reporte_mantenimiento_programador"})
public class registra_solucion_reporte_mantenimiento_programador extends HttpServlet {
...
"            function presiona1(){\n" +
"                setTimeout(function (){\n" +
"                    window.location.replace('consulta_reportes_mantenimiento__programador.jsp');\n" +
"                },0);\n" +
"            }\n" +
"            function presiona2(){\n" +
"                setTimeout(function (){\n" +
