 ...
 * @author devil
 */
@WebServlet(name = "elimina_pregunta", urlPatterns = {"/elimina_pregunta"})
public class elimina_pregunta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet elimina_pregunta</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<script>\n" +
"            function presiona1(){\n" +
...
"        </script>");
            ...
            int valida=controla_preguntas.borrapreguntas(id_pregun);
            if(valida==1){
                out.println("<script>alert('Eliminacion Exitosa');</script>");
