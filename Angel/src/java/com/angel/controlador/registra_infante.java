 ...
 * @author devil
 */
@WebServlet(name = "registra_infante", urlPatterns = {"/registra_infante"})
public class registra_infante extends HttpServlet {
            ...
            if (valida1 == 1) {
                ...
                if (!(usua == null)) {
                    ...
                    try{
                        ...
                        infan=new infante(0, unnombre, unapellido_p, unapellido_m, peso, altura, sexo, fecha_nu);
                        ...
                        if(validado==0){
                            ...
                            infan=new infante(0, nombre, apellido_p, apellido_m, peso, altura, sexo, fecha_nu);
                            int validado2=controla.altainfante(infan, correo, id_dispositivo, afecciones);
                            if(validado2==1){
                                out.println("<script>alert('Infante Registrado');</script>");
