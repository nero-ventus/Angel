 ...
 */
@WebServlet(name = "registra_reporte_mantenimiento_sin_asignar", urlPatterns = {"/registra_reporte_mantenimiento_sin_asignar"})
public class registra_reporte_mantenimiento_sin_asignar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            reporte_mantenimiento repor = new reporte_mantenimiento(0, fecha_re, 0, descrip, "", tipo, "");
            int valida = controla_reportes.registra_reporte_mantenimiento_sin_asignar(repor);
            if (valida == 1) {
