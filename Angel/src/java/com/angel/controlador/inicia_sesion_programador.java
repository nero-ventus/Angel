 ...
 */
@WebServlet(name = "inicia_sesion_programador", urlPatterns = {"/inicia_sesion_programador"})
public class inicia_sesion_programador extends HttpServlet {
...
"        </script>");
            ...
            programador program=controla_programador.traeprogramador(new programador(correo, contra, "", ""));
            if(!(program==null)){
