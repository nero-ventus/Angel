 ...
 */
@WebServlet(name = "registra_gerente_mantenimiento", urlPatterns = {"/registra_gerente_mantenimiento"})
public class registra_gerente_mantenimiento extends HttpServlet {
...
"            }</script>");
            ...
            gerente_mantenimiento geren=new gerente_mantenimiento(correo, contra, nombre, apellidos);
            int valida=controla_gerente_mantenimiento.altagerente_mantenimiento(geren);
            if(valida==1){
