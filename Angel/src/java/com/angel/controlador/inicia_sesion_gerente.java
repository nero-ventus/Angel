 ...
 * @author devil
 */
@WebServlet(name = "inicia_sesion_gerente", urlPatterns = {"/inicia_sesion_gerente"})
public class inicia_sesion_gerente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet inicia_sesion_gerente</title>");            
            out.println("<script>\n" +
"            function presiona1(){\n" +
"                setTimeout(function (){\n" +
"                    window.location.replace('administrador_home_gerente.jsp');\n" +
"                },0);\n" +
"            }\n" +
"            function presiona2(){\n" +
"                setTimeout(function (){\n" +
...
"        </script>");
            out.println("</head>");
            out.println("<body>");
            Igerentedao controla_administrador=new impgerente();
            ...
            ingeniero inge=controla_administrador.traegerente(new ingeniero(correo, contra, "", ""));
            if(!(inge==null)){
