 ...
 * @author devil
 */
@WebServlet(name = "inicia_sesion_administrador", urlPatterns = {"/inicia_sesion_administrador"})
public class inicia_sesion_administrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet inicia_sesion_administrador</title>");            
            out.println("</head>");
            out.println("<script>\n" +
"            function presiona1(){\n" +
"                setTimeout(function (){\n" +
...
"        </script>");
            ...
            administrador admin=controla_administrador.traeadministrador1(correo, contra);
            if(!(admin==null)){
