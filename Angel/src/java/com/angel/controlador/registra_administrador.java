 ...
 * @author Profesor
 */
@WebServlet(name = "registra_administrador", urlPatterns = {"/registra_administrador"})
public class registra_administrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet registra_administrador</title>");            
            out.println("</head>");
...
"            }</script>");
            ...
            administrador admi=new administrador(correo, contra, nombre, modulo);
            int verifica=controla_administrador.altaadministrador(admi);
            if(verifica==1){
