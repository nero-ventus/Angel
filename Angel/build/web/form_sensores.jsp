<%-- 
    Document   : form_sesores
    Created on : 12/11/2018, 01:34:21 PM
    Author     : Alumno
--%>
...
<html>
    <head>
        ...
        <style>
            body{
                background: url(fondous4.jpg) no-repeat center center fixed;
    ...
    <body>
        ...
        <ul id="dropdown1" class="dropdown-content">
            ...
            <li class="blue flow-text"><a href=""><i class="material-icons left">my_location</i>Ubicación</a></li>
        ...
        <ul class="sidenav blue" id="mobile-demo"style="margin-top: 4.5em" >
            ...
            <li class="blue white-text flow-text"><a href="" class="white-text"><i class="material-icons left white-text">my_location</i>Localización</a></li>
                                ...
                                <tr>
                                    ...
                                    %>
                                            ...
                                            <li class="collection-item avatar">
                                                <i class="material-icons circle blue large">child_friendly</i>
                                                <span class="title">Número de bebé: <%out.print((i+1));%></span>
                                                ...
                                                <div id="editarnumerodebebe_obtenido<%out.print((i+1));%>" class="modal" style="margin-top: 1em">
                                                    <div class="modal-content" style="text-align: center">
                                                        <h4 class="center">Bebé numbebe_obtenido:</h4>
                                                        <h5>Edita la información del sensor</h5>
                                                        <div class="switch col s12 m12 l12 ">
                                                            Editar:<br>
                                                            <label>
                                                                No
                                                                <input id="cambia<%out.print((i+1));%>" type="checkbox" onclick="hab_numbebe_obtenido<%out.print((i+1));%>()">
                                                        ...
                                                        <form action="cambiar_infante" id="form<%out.print((i+1));%>" method="post">
                                                            ...
                                                            <div class="input-field col s12 m3 l3">
                                                                ...
                                                                <div class="col s6 m3 l3" id="permiso_o<%out.print((i+1));%>">
                                                            ...
                                                            <div class="input-field col s6 m3 l3" style="display: none" id="cuarto<%out.print((i+1));%>">
                                                            ...
                                                            <div class="col s6 m3 l3" id="cuarto_o<%out.print((i+1));%>">
                                                                <br> 
                                                            </div>
                                                                <script>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <div class="col s6">
                                                                    <form method="post" action="elimina_infante">
                                                                        <div class="hide">
                                                                            <input type="text" value="<%out.print(lista_sensores.get(i).getId_sensor());%>"name="infan">
                                                                        </div>
