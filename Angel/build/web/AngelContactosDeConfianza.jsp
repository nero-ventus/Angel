...
<html>
    <head>
        <title>Angel-Contactos de Confianza</title>
        <meta charset="UTF-8">
        ...
        <script>
            function hab() {
                if (document.getElementById('switch1').checked)
                {
                    ...
                    document.getElementById("ncontra").disabled = false;
                    document.getElementById("nccontra").disabled = false;
                    ...
                    document.getElementById("fotoperfil").classList.add('disabled');
                    ...
                    document.getElementById("ncontra").disabled = true;
                    document.getElementById("nccontra").disabled = true;
    ...
    <body>
        ...
        <nav class="blue" style="z-index: 99999">
            <div class="nav-wrapper ">
                <a class="brand-logo flow-text center"><i class="material-icons t">contact_mail</i>Contactos</a>
                ...
                <div class="row">
                    <div class="responsive-table table-status-sheet"style="margin-top: 5em">
                        <table class="bordered white">
                            <thead>
                                <tr>
                                    <th colspan="2" class="center flow-text"><H5>Agrega aqui tus contactos de confianza</H5></th>
