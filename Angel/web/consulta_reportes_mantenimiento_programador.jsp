...
<html>
        ...
        <style>
            ...
            *::-webkit-input-placeholder {
            ...
            ul.dropdown-content.select-dropdown li span {
                color: #4caf50 ; /* no need for !important :) */
            }   
            *::-webkit-input-placeholder {
                /* Google Chrome y Safari */
                color: #757575;
    ...
    <body>
        <%
            ...
            programador geren = new programador(correo, contra, "", "");
            geren = controla_programador.traeprogramador(geren);
            if (!(geren == null)) {
        ...
        <nav>
            <div class="nav-wrapper green darken-3">
                ...
                <ul id="nav-mobile" class="left hide-on-med-and-down">
                    <li><a href="administrador_home_programador.jsp"><i class="material-icons left">arrow_back</i>Regresar al inicio</a></li>                </ul>
            </div>
        </nav>
                ...
                <div class="row">
                    <div class="responsive-table table-status-sheet"style="margin-top: 5em">
                        <table class="bordered white">
                            ...
                            <th><form action="consulta_reportes_mantenimiento_programador.jsp" method="post" id="filtro" name="filtro">
                                ...
                                <tr>
                                    <td>
                                            ...
                                            <li class="collection-item avatar">
                                                <i class="material-icons circle green darken-3 large" style="position: absolute; top:30%">assignment</i>
                                               ...
                                               <%if (lista.get(i).getEstado() == 1) {%>
                                                ...
                                                <p>Correo del responsable: <u> <%out.print(lista.get(i).getCorreo_gere());%> </u></p>
                                                        <%                                                    if (lista.get(i).getEstado() == 1 || lista.get(i).getEstado() == 3  ) {
                                                        %>
                                                ...
                                                <form action="registra_solucion_reporte_mantenimiento_gerente" method="post">
                                                    ...
                                                    <button  class="btn-large green darken-3 col m3 s12 l3 white-text waves-effect waves-light" type="submit" name="action" style="left: 36%">Soluciona<i class="white-text material-icons right">send</i>
                                                    </button> 
                                                ...
                                                <form action="registra_solucion_especial" id="form<%out.print((i + 1));%>" method="post">
                                                    ...
                                                    <input type="text" name="id_repor" class="hide" value="<%out.print(lista.get(i).getId_repor_mantenimiento());%>">
                                                    <button  class="btn-large green darken-3 col m3 s12 l3 white-text waves-effect waves-light" type="submit" name="action" style="left: 36%">Envía una solución<i class="white-text material-icons right">send</i>
                                                    </button> 
