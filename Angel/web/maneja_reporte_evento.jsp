                        ...
                        <table class="bordered white">
                            <thead>
                                <tr>
                                    ...
                                    <th><form action="maneja_reporte_evento.jsp" method="post" id="filtro" name="filtro">
                                            <select name="filtro" id="filtro_s" onchange="cambia_pag()">
                                                <option selected value="1">Abiertos sin asignar</option>
                                                <option value="2">Abiertos asignados</option>
                                                <option value="3">Cerrados solucionados</option>
                                            </select>
                                        </form></th>
                                </tr>
                            </thead>
                                        ...
                                        <ul class="collection">
                                            <%
                                                try{                                             
                                                    ...
                                                    if(filtro==1){
                                                        lista=controla_reporte.trae_reportes_evento_abiertos_sin_asignar();
                                                    }
                                                    if(filtro==2){
                                                        lista=controla_reporte.trae_reportes_evento_abiertos_asignados();
                                                    }
                                                    if(filtro==3){
                                                        lista=controla_reporte.trae_reportes_evento_cerrados_resueltos();
                                                    }
                                            ...
                                            <li class="collection-item avatar">
                                                ...
                                                %>
                                                    <p>Estado: Abierto</p>    
                                                    <%
                                                        if((filtro==2 || filtro==1) && !(lista.get(i).getSolucion().equals("Sin Resolver"))){
                                                    %>
