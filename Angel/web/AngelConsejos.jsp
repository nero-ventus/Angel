        ...
        <nav class="blue" style="z-index: 99999">
            <div class="nav-wrapper">
                ...
                <ul class="right hide-on-med-and-down">
                    <li><a href="Home.jsp"><i class="material-icons left">home</i>Inicio</a></li>
                    <li><a href=""><i class="material-icons right">help</i>Ayuda</a></li>
                    <li><a href="cerrar_sesion"><i class="material-icons right">power_settings_new</i>Cerrar Sesión</a></li>
                </ul>
            </div>
        </nav>   
        <ul class="sidenav" id="mobile-demo">
            <li><a href="AngelEditarUsuario.html"><i class="material-icons right">edit</i>Editar Información</a></li>
