    ...
    <body>
        <%
            ...
            if (valida == 1) {
                ...
                if (!(usua == null)) {int id_infan=Integer.parseInt(request.getParameter("id_infa"));
        ...
        <nav class="blue" style="z-index: 99999">
            <div class="nav-wrapper ">
                <a class="brand-logo flow-text center"><i class="material-icons t">local_hospital</i>Estado Médico</a>
