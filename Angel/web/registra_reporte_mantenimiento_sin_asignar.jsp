...
<html>
    <head>
        <title>Registra reporte de mantenimiento sin asignar</title>
        <meta charset="UTF-8">
        ...
        <style>
            ...
            *::-webkit-input-placeholder {
            ...
            ul.dropdown-content.select-dropdown li span {
                color: #2e7d32; /* no need for !important :) */
            }   
            *::-webkit-input-placeholder {
                /* Google Chrome y Safari */
                color: #757575;
        ...
        <div class="contenedor-principal">
            <div class="row">
                ...
                <div class="row container white" style="margin-top: 7em; ">
                    ...
                    <form action="registra_reporte_mantenimiento_sin_asignar" method="post">
                        ...
                        <button class="btn btn-large col s6 green darken-3" type="submit" name="action">Genera el reporte
